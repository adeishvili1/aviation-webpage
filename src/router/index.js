...
const routes = [
  ...
  // Innovation
  { path: '/innovation/elite-jet', name: 'InnovationEliteJet', component: () => import('../pages/innovation/elite-jet.vue') },
  { path: '/innovation/ge-31-bora', name: 'InnovationGE31Bora', component: () => import('../pages/innovation/ge-31-bora.vue') },
